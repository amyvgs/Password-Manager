...
const ViewAllPasswords = ({}) => {
  const { isLoading, allPasswords, uiUpdateChange, handleDeletePassword } =
    usePasswords("all", {});
  ...
  return (
    <>
      <div className="flex flex-col w-full h-4/5 items-center justify-start bg-gray-100 dark:bg-slate-700 shadow-lg p-10 font-Roboto max-sm:overflow-y-auto">
        ...
        <div className="flex flex-col items-center justify-start w-full h-4/5 bg-gray-300 dark:bg-slate-800 p-5 overflow-y-scroll">
          {isLoading ? (
